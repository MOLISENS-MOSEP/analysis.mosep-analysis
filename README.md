# MOLISENSext Analysis

This repo contains the tools to analyse data from the MOLISENSextended setup.
...
make convert_pptx
```
in MOLISENSext Analysis environment to convert all pptx files in presentations to pdf for use in the LaTeX report.
...
```
"mounts": ["source=WHEVEVER_YOUR_DATA_IS,target=/MOLISENSext Analysis/data/1raw/,type=bind,consistency=cached"
```
